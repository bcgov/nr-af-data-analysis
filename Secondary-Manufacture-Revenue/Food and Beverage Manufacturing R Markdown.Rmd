...
naics_set311 <- c("311", "3111", "3112", "3113", "3114"
                  , "3115", "3116", "3117", "3118")
label311 <- "3119 Other food manufacturing"
...
label312 <- "3122 Other beverage, tobacco and cannabis manufacturing"
...
wide312[, `:=`(
  ...
  NAICS_Code = label312,
  NAICS      = "3122 Other beverage, tobacco and cannabis manufacturing"
)]
...
# Drop NAICS Codes (rows) that have been re-calculated as 311R and 312R 
NAICS4 <- NAICS4[NAICS_Code != '3119']
NAICS4 <- NAICS4[NAICS_Code != '3122']
NAICS4 <- NAICS4[NAICS_Code != '3123']
