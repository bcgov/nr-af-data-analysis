...
Commodity_REF <- fread("C:/Users/[replace with IDIR]/Government of BC/SICI Data Library Subsite - Unpublished Data/CATSNET HS8.csv",
...
# Load the list of agriculture, seafood and food manufacturing HS codes 
Commodity_REF <- fread("C:/Users/[replace with IDIR]/Government of BC/SICI Data Library Subsite - Unpublished Data/CATSNET HS10.csv",
                       colClasses = c(HS10_code = "character"))

Commodity_REF <- Commodity_REF %>% 
  rename(HS10 = HS10_code)

# Join left with the Commodity_REF to filter for relevant HS codes only
Import_Update <- Import_Update  %>%
  merge(Commodity_REF,by="HS10")
...
setwd("C:/Users/[replace with IDIR]/Government of BC/SICI Data Library Subsite - Unpublished Data")
...
# Specify date as type
Trade_Import$Date <- ymd(Trade_Import$Date)
