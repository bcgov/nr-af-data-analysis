...
fwrite(Trade_DomExport, 
       "C:/Users/[replace with IDIR]/Government of BC/SICI Data Library Subsite - Unpublished Data/Trade_DomExport.csv",
       row.names = FALSE,
       col.names = TRUE,
       buffMB = 10)
...
# Write the csv file with same dynamic name into the working directory
fwrite(Trade_Import, 
       "C:/Users/leb[replace with IDIR]autis/Government of BC/SICI Data Library Subsite - Unpublished Data/Trade_Import.csv",
       row.names = FALSE,
       col.names = TRUE,
       buffMB = 10)
